...
export function render(container) {
  ...
  function finishExperiment() {
    arena.innerHTML = `<div style="display:flex; align-items:center; justify-center; height:100%; color:#46d369; font-weight:bold; font-size:16px;">Target Acquisition Complete!</div>`;
